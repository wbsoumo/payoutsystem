...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12" x-data="{ tab: 'curl', activeSection: 'overview' }">
    <div class="grid lg:grid-cols-12 gap-12">
        ...
        <aside class="lg:col-span-3 space-y-6">
            <div class="space-y-3">
                <span class="text-sm font-bold text-slate-400 uppercase tracking-wider block">API REFERENCE</span>
                <nav class="space-y-1">
                    <button @click="activeSection = 'overview'" :class="activeSection === 'overview' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'" class="w-full text-left px-4 py-2.5 text-[15px] font-bold rounded-xl transition-colors">Overview</button>
                    <button @click="activeSection = 'auth'" :class="activeSection === 'auth' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'" class="w-full text-left px-4 py-2.5 text-[15px] font-bold rounded-xl transition-colors">Authentication</button>
                    <button @click="activeSection = 'signatures'" :class="activeSection === 'signatures' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'" class="w-full text-left px-4 py-2.5 text-[15px] font-bold rounded-xl transition-colors">HMAC Verification</button>
                </nav>
            </div>
            <div class="space-y-3">
                <span class="text-sm font-bold text-slate-400 uppercase tracking-wider block">CORE ENDPOINTS</span>
                <nav class="space-y-1">
                    <button @click="activeSection = 'balance'" :class="activeSection === 'balance' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'" class="w-full text-left px-4 py-2.5 text-[15px] font-bold rounded-xl transition-colors">
                        <span class="inline-block px-2 py-0.5 text-[10px] bg-blue-100 text-blue-700 font-bold rounded mr-1.5">GET</span> Get Wallet Balance
                    </button>
                    <button @click="activeSection = 'payout'" :class="activeSection === 'payout' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'" class="w-full text-left px-4 py-2.5 text-[15px] font-bold rounded-xl transition-colors">
                        <span class="inline-block px-2 py-0.5 text-[10px] bg-green-100 text-green-700 font-bold rounded mr-1.5">POST</span> Create Payout
                    </button>
                    <button @click="activeSection = 'status'" :class="activeSection === 'status' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'" class="w-full text-left px-4 py-2.5 text-[15px] font-bold rounded-xl transition-colors">
                        <span class="inline-block px-2 py-0.5 text-[10px] bg-blue-100 text-blue-700 font-bold rounded mr-1.5">GET</span> Get Payout Status
                    </button>
                </nav>
            </div>
        </aside>
        ...
        <main class="lg:col-span-9 space-y-12">
            ...
            <div x-show="activeSection === 'overview'" class="space-y-6">
                ...
                <div class="space-y-3 text-base text-slate-600 leading-relaxed">
                    <h3 class="font-bold text-slate-900 text-lg">Gateway Details</h3>
                    <p>Base URL: <code class="bg-slate-100 px-2 py-1 rounded font-mono text-sm text-blue-600">https://taskbazi.xyz/api/v1</code></p>
            ...
            <div x-show="activeSection === 'auth'" class="space-y-6">
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-1">Include these required HTTP headers in every request.</p>
                </div>
                <div class="overflow-x-auto border border-slate-200 rounded-2xl bg-white shadow-sm">
                    <table class="min-w-full divide-y divide-slate-200 text-left text-sm">
                        <thead class="bg-slate-50 text-slate-500 font-bold">
                            <tr>
                                <th class="px-6 py-4">Header Name</th>
            ...
            <div x-show="activeSection === 'signatures'" class="space-y-6">
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-1">To construct a valid signature:</p>
                </div>
                
                <div class="p-6 bg-slate-50 rounded-2xl border border-slate-100 text-sm space-y-4 text-slate-700">
                    <span class="font-bold text-slate-900 text-base block">1. Concatenate fields with a dot (.) separator:</span>
                    <pre class="bg-slate-900 text-slate-200 p-4 rounded-xl font-mono text-[12.5px]">stringToSign = timestamp + "." + nonce + "." + requestBodyJsonString</pre>
                    
                    <span class="font-bold text-slate-900 text-base block mt-4">2. Calculate SHA256 HMAC using your Secret Key:</span>
                    <pre class="bg-slate-900 text-slate-200 p-4 rounded-xl font-mono text-[12.5px]">signature = hmacSha256(stringToSign, yourSecretKey)</pre>
                </div>
            </div>
            ...
            <div x-show="activeSection === 'balance'" class="space-y-6">
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-1">Retrieve current available and frozen balance details.</p>
                </div>

                <div class="grid lg:grid-cols-12 gap-8 items-start">
                    <div class="lg:col-span-6 space-y-4">
                        <div class="flex items-center gap-3">
                            <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-lg text-xs font-bold uppercase border border-blue-200">GET</span>
                            <code class="text-sm font-bold font-mono text-slate-800">/wallet/balance</code>
                        </div>
                        
                        <div class="space-y-2">
                            <span class="text-xs font-bold text-slate-400 uppercase tracking-wider block">SUCCESS RESPONSE (200)</span>
                            <pre class="bg-slate-900 text-slate-200 p-4 rounded-xl font-mono text-[12.5px] overflow-x-auto">{
  "success": true,
  "balance": 154500.50,
  "frozen_balance": 0.00,
  "currency": "INR"
                    ...
                    <div class="lg:col-span-6 bg-slate-900 rounded-2xl p-5 text-slate-200">
                        ...
                        <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">curl -X GET https://taskbazi.xyz/api/v1/wallet/balance \
  ...
  -H "x-nonce: random_uuid_string"</pre>
            ...
            <div x-show="activeSection === 'payout'" class="space-y-6">
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-1">Initiate a transfer to a customer bank account. Deducts from wallet balance.</p>
                </div>

                <!-- Languages Tabs -->
                <div class="flex flex-wrap gap-2 border-b border-slate-200 pb-2 text-sm">
                ...
                <div class="grid lg:grid-cols-12 gap-8 items-start">
                    <div class="lg:col-span-5 space-y-4">
                        <div class="flex items-center gap-3">
                            <span class="px-3 py-1 bg-green-50 text-green-700 rounded-lg text-xs font-bold uppercase border border-green-200">POST</span>
                            <code class="text-sm font-bold font-mono text-slate-800">/payouts</code>
                        </div>
  ...
  "bank_holder_name": "John Doe"
                    ...
                    <div class="lg:col-span-7 bg-slate-900 rounded-2xl p-5 text-slate-200 overflow-hidden min-w-0">
                        ...
                        <div x-show="tab === 'curl'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">curl -X POST https://taskbazi.xyz/api/v1/payouts \
  ...
  -d '{
    ...
    "bank_holder_name": "John Doe"
                        ...
                        <div x-show="tab === 'php'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">&lt;?php
...
?&gt;</pre>
                        ...
                        <div x-show="tab === 'node'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">const crypto = require('crypto');
...
const signature = crypto
  ...
  .digest('hex');</pre>
                        ...
                        <div x-show="tab === 'python'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">import time, uuid, hmac, hashlib, json, requests
...
signature = hmac.new(secret_key.encode(), string_to_sign.encode(), hashlib.sha256).hexdigest()</pre>
                        ...
                        <div x-show="tab === 'cpp'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">#include &lt;iostream&gt;
#include &lt;sstream&gt;
#include &lt;iomanip&gt;
...
std::string compute_hmac(const std::string& key, const std::string& msg) {
    ...
    return ss.str();
                        ...
                        <div x-show="tab === 'go'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">package main
import (
	"crypto/hmac"
	"crypto/sha256"
	"encoding/hex"
...
func main() {
	...
	signature := hex.EncodeToString(h.Sum(nil))
                        ...
                        <div x-show="tab === 'java'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">import javax.crypto.Mac;
    ...
    public static String calculateHMAC(String data, String key) throws Exception {
        ...
        return hex(rawHmac);
                        ...
                        <div x-show="tab === 'csharp'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">using System;
        ...
        using (var hmacsha256 = new HMACSHA256(keyByte)) {
            ...
            return BitConverter.ToString(hashmessage).Replace("-", "").ToLower();
                        ...
                        <div x-show="tab === 'ruby'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">require 'openssl'
require 'net/http'
require 'json'
...
signature = OpenSSL::HMAC.hexdigest('SHA256', secret, string_to_sign)</pre>
                        ...
                        <div x-show="tab === 'swift'" class="space-y-2">
                            ...
                            <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">import Foundation
import CryptoKit
...
let code = HMAC&lt;SHA256&gt;.authenticationCode(for: (timestamp + "." + nonce + "." + body).data(using: .utf8)!, using: key)</pre>
            ...
            <div x-show="activeSection === 'status'" class="space-y-6">
                <div>
                    ...
                    <p class="text-slate-500 text-sm mt-1">Check status and provider reference details for a specific payout.</p>
                </div>
                ...
                <div class="grid lg:grid-cols-12 gap-8 items-start">
                    <div class="lg:col-span-6 space-y-4">
                        <div class="flex items-center gap-3">
                            <span class="px-3 py-1 bg-blue-50 text-blue-700 rounded-lg text-xs font-bold uppercase border border-blue-200">GET</span>
                            <code class="text-sm font-bold font-mono text-slate-800">/payouts/{reference_id}</code>
                        </div>
  ...
  "created_at": "2026-07-26T12:00:00Z"
                    ...
                    <div class="lg:col-span-6 bg-slate-900 rounded-2xl p-5 text-slate-200">
                        <span class="text-xs font-bold text-slate-400 block uppercase mb-3">cURL Request</span>
                        <pre class="font-mono text-[12.5px] overflow-x-auto text-slate-300">curl -X GET https://taskbazi.xyz/api/v1/payouts/tx_abc123xyz \
  -H "x-api-key: nvx_pk_live_your_key" \
  -H "x-merchant-id: your_merchant_id" \
